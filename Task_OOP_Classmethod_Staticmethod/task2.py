# Перед вами имеется реализация класса RobotVacuumCleaner. Сейчас над каждым методом стоит
# знак _.
# Ваша задача сделать код корректным, для это нужно заменить знак _ на один из декораторов
