...
# Цельсия и переводит ее в градусы по Фаренгейту, используя следующую формулу:
#
# статический метод fahrenheit_to_celsius, который принимает температуру в градусах по
# Фаренгейту и переводит ее в градусы по Цельсия, используя следующую формулу:
# Во всех этих формулах буква С обозначает градусы по цельсию, а буква F - градусы по
# Фаренгейту
#
# Sample Input:
#
