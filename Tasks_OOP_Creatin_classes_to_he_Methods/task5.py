# Необходимо создать приложение для учета задач, которое будет использовать классы Task,
# TaskList и TaskManager.
# Класс Task будет хранить информацию о задаче (название, описание, статус выполнения),
# состоит из:
#
# метода __init__, принимающий и сохраняет в атрибуты экземпляра name,
# description и status. По умолчанию status равен False.
#
...
#
#
# Класс TaskManager будет содержать методы для отображения списка задач и изменения
# статуса выполнения задач. В нем должно быть реализовано:
#
# метод __init__, который должен принимать экземпляр TaskList и сохранять его в атрибуте
# task_list.
#
# метод mark_done, который принимает задачу (экземпляр Task) и устанавливает ей истинный
# статус выполнения.
#
# метод mark_undone, который принимает задачу (экземпляр Task) и устанавливает ей ложный
# статус выполнения.
#
