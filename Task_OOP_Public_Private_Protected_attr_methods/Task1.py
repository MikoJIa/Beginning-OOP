...
#
# конструктор __init__, который принимает 3 аргумента и создает
# приватные атрибуты __name, __age, __branch;
#
# приватный метод __display_details , который выводит на экран информацию о студенте в
# следующем виде:
# Имя: <name>
# Возраст: <age>
# Направление: <branch>
